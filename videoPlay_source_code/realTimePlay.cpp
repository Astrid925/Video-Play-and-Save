                ...
                if((packet->flags&AV_PKT_FLAG_KEY))  // 找到关键帧
                   {
                        ...
                        {
                            if(cPacketData[n] == 0 && cPacketData[n + 1] == 0 && cPacketData[n + 2] == 0 && cPacketData[n + 3] == 1 && cPacketData[n + 4] == 101) // 针对h264编码
                            {
...
qint64 realTimePlay::oneFrameTime()
{
    return in_duration;
}

QString realTimePlay::saveFileName()
{
